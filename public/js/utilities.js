...
HTMLElement.prototype.prependChild = function (nodeHTML){
	this.insertBefore(nodeHTML, this.firstChild)
}
...
HTMLInputElement.prototype.trigger = function (nameEvent){
	var event = new Event(nameEvent)
	this.dispatchEvent(event)
}
HTMLSelectElement.prototype.trigger = HTMLInputElement.prototype.trigger
...
HTMLElement.prototype.serialize = function (){
	var elements = this instanceof HTMLFormElement ? this.elements: this.querySelectorAll('input, select'),
